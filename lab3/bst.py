class BinarySearchTree:
    ...
    # Find the smallest key and return the corresponding keyvalue pair/tuple, i.e. (key, value)
    def smallest(self):
        x = self.root
        while x.left != None:
            x = x.left
    ...
    # Find the largest key and return the corresponding keyvalue pair/tuple, i.e. (key, value)
    def largest(self):
        x = self.root
        while x.right != None:
            x = x.right
